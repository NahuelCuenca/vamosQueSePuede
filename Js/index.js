...
async function obtenerInfo (uid) {

    let response = await fetch(`https://api.mercadopago.com/checkout/preferences/${uid}`,{
        method: "GET",
        headers: {
          Authorization:
            "Bearer TEST-7552246970994987-012020-b87ccda58d82d7e2069fc3e59c2ba43c-1008272387",
        },
    })
